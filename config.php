...
//$site_addr = "http://65.1.147.100/";

// Can Be Set Manually Like "http://localhost/mysite/".

$site_addr = (isset($_SERVER["HTTPS"]) && $_SERVER["HTTPS"] !== "off" ? "https" : "http") . "://" . $_SERVER["HTTP_HOST"] . "/";
$site_addr = rtrim($site_addr, "/\\") . "/";
...
define("DB_HOST", "localhost"); // Use the container name as the host
define("DB_USERNAME", "root"); // As per your MySQL container environment
define("DB_PASSWORD", "Admin@1234"); // As per your MySQL container environment
define("DB_NAME", "preschool"); // Use your desired database name
define("DB_TYPE", "mysql");
define("DB_PORT", "3306"); // Exposed port from Docker Compose
define("DB_CHARSET", "utf8");
